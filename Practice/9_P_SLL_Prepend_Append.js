...
class SinglyLinkedList {
    ...
    appendValue(loc, value) {
        ...
        // for loop's (i < loc) allows for the runner to go right before the location
        for (var i = 0; i < loc; i++) {
            runner = runner.next
        }
        //once right runner is righ before location, create new node
        var new_node = new ListNode(value);
        // console.log(runner)
        // console.log(loc)
        // console.log(runner.next)
        // attach the node's next property to runner's next
        new_node.next = runner.next

        // attach runner's next property to the new node (connnects the two)
